...
const UUID = process.env.UUID || '87726a2e-4069-4e98-8ef5-1c598799f403'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || '87726a2e-4069-4e98-8ef5-1c598799f403';            // 获取节点的订阅路径
